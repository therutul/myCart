...
router.get('/add-product-type',adminController.addProductType)
router.post('/add-product-type',adminController.addProductTypePost)
router.post('/viewtype',adminController.viewProductType)
